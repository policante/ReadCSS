 ...
 */
public class Parser implements GlobalConstants{
     ...
     */
    public Parser(InputStream source, CSSHandler handler) throws IOException
    {
        s = new CSSScan(source);
     ...
     * @see GlobalConstants
     */
    private void match(int matcher) throws Exception {
