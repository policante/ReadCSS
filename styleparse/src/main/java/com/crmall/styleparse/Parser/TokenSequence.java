...
public class TokenSequence implements Iterable<Token>{
    ...
    {
        CSSScan scanner = new CSSScan(new ByteArrayInputStream(s.getBytes()));
        Builder builder = new Builder();
        Token t = scanner.nextToken();
        while (t.tokenCode != GlobalConstants.EOF)
        {
            builder.append(t);
            t = scanner.nextToken();
        }
     ...
     * on either {@link GlobalConstants#COLON} or {@link GlobalConstants#DOUBLE_COLON}.
     * @param t
     * @return
     */
